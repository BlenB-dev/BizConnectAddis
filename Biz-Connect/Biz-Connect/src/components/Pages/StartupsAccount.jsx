          ...
          >
            <ul className="space-y-3 text-dark ">
              ...
              <div className="flex items-center relative">
                <a
                  href="/ProfileSettingsPageForStartups"
                  className="flex items-center"
                >
                  <label className="flex items-center block font-medium whitespace-nowrap transform transition-colors duration-200 border-r-4 border-transparent hover:border-red-600 cursor-pointer">
